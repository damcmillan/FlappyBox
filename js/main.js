//Initialie Phaser Engine. Create a 400x490px game!
...
var mainState = {
  ...
  create: function() {
    //This function is called preload function 
    //This is where we set up the game assets from earlier
    
    game.physics.startSystem(Phaser.Physics.ARCADE);
    
    this.bird = this.game.add.sprite(100, 245, 'bird.png');
